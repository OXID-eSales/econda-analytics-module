...
class TrackingTest extends BaseAcceptanceTestCase
{
    ...
    {
        $this->open($this->getTestConfig()->getShopUrl() .'index.php?cl=details&cnid=oeecondaanalyticscategoryid&anid=1001');
    ...
    {
        $this->open($this->getTestConfig()->getShopUrl() .'index.php?cl=details&cnid=oeecondaanalyticscategoryid&anid=1002');
    ...
    public function testLogin()
    {
        ...
        $this->checkIfElementInPage($this->prepareElementForLoginEvent('"'.md5('oeecondaanalyticstestuser').'",0'));
        $this->checkIfElementInPage($this->prepareElementForEmailShowEvent('testing_account@oxid-esales.local'));
