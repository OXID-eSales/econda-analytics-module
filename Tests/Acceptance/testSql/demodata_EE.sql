...
REPLACE INTO `oxuser`
SET
  `OXID` = 'oeecondaanalyticstestuser',
  `OXACTIVE` = 1,
  `OXRIGHTS` = 'user',
  `OXSHOPID` = 1,
...
SET
  `OXID` = 'oeecondaanalyticscategoryid',
  `OXMAPID` = 101,
  `OXPARENTID` = 'oxrootid',
  `OXLEFT` = 1,
  `OXRIGHT` = 4,
  `OXROOTID` = 'oeecondaanalyticscategoryid',
  `OXSORT` = 1,
  `OXACTIVE` = 1,
  `OXHIDDEN` = 0,
  `OXSHOPID` = 1,
...
SET
  `OXID` = 'oeecondaanalyticsid',
  `OXSHOPID` =  1,
  `OXOBJECTID` = '1000',
  `OXCATNID` = 'oeecondaanalyticscategoryid',
  `OXPOS` = 0,
  `OXTIME` = 1202134861;
REPLACE INTO `oxobject2category`
SET
  `OXID` = 'oeecondaanalyticsid2',
  `OXSHOPID` =  1,
  `OXOBJECTID` = '1001',
  `OXCATNID` = 'oeecondaanalyticscategoryid',
  `OXPOS` = 0,
